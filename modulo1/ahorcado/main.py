...
palabras = '''hormiga'' babuino tejon murcielago oso castor camello gato
            almeja cobra pantera coyote cuervo ciervo perro burro pato
...
def obtenerPalabraAlAzar(listaDePalabras):
    #  Esta función devuelve una cadena al azar de la lista de cadenas
...
def mostrarTablero(IMÁGENES_AHORCADO, letrasIncorrectas,
    ...
    #   los espacios vacíos con las letras adivinadas
...
def obtenerIntento(letrasProbadas):
    #  la letra ingresada por el jugador. Verifica que el jugador
    #  ha ingresado sólo una letra, y no otra cosa.
    while True:
    ...
    if intento in palabraSecreta:
        ...
        if len(letrasIncorrectas) == len(IMÁGENES_AHORCADO) - 1:
            ...
            print('¡Te has quedado sin intentos!\nDespués de '
                  ...
                  + palabraSecreta + '"')
            juegoTerminado = True
    #  al jugador si quiere volver a jugar
